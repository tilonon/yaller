...
<body class="theme-blue"> 
        <!-- ====== Header Top Area ====== --> 
    <header class="header-top-area theme-blue-bg">
    ...
    <!-- ======Google Map Area======= --> 
    <div class="google-map-area with-search-contanct">
        <div class="container-fluid">
            <div class="row">
                <div class="header-map-content">
                    <iframe height="650" src="https://www.google.com/maps/embed/v1/place?key=AIzaSyC871wKM6aoCLSV_pT3xBVsYzNGXaDh7Pw&q=121+King+St,Melbourne+VIC+3000,Australia" allowfullscreen="allowfullscreen"></iframe>
                </div><!-- /.map-content -->
                

                <!-- ====== Check Vehicle Area ====== --> 
                <div class="check-vehicle-block check-boxshadow col-md-7">
                    <form action="result.php" method="post" class="advance-search-query check-vehicle-two theme-blue">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="input">
                                        <select name="localisation">
                                            <option value="0" selected="selected" >--------------------------------CHOISISSEZ VOTRE LOCALISATION--------------------------------</option>
                                            <option value="mbadon">M'BADON</option>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="input">
                                        <select name="destination">
                                            <option value="0" selected="selected" >---------------------------------CHOISISSEZ VOTRE DESTINATION--------------------------------</option>
                                            
                                            <option value="9kilo">9 kilo</option>
                        ...
                        <div class="check-vehicle-footer">
                            <div class="row">                            
                                ...
                                <!-- <button valider' href="resultat.php" class="boutton">Y-ALLER</a> -->
                                <button name="valider" type="submit" class="button">Y-aller</button>
                            </div><!-- /.row -->
    ...
    <footer class="footer-block bg-black blue-theme" style="background-color: orange;">
        <div class="container">
            <!-- footer-top-block -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6 pd-30">
                        <div class="widget widget_hot_contact">
                            ...
                            <ul>
                                <li><a href="#"><i class="fa fa-envelope"></i>yaller@gmail.com</a></li>
                                <li><a href="#"><i class="fa fa-phone"></i>(+225)05 56894212</a></li>
                                <li><a href="#"><i class="fa fa-map-marker"></i>TRES PROCHAINEMENT DANS LE VITIB</a></li>
                            </ul> 
                        </div><!-- /.widget -->
                        <div class="widget widget_newsletter">
                            ...
                            <form action="#" class="subscribes-newsletter" method="get">
                                ...
                                <div class="input-group">
                                    <input type="search" name="s" placeholder="VOTRE MAIL" class="form-controller">
                ...
                <div class="row">
                     <div class="col-md-9">
                        <div class="bottom-content-left">
                            <p class="copyright">Copyright &copy; 2023 yaller  -  Tous droits reservés <a href="#"> yaller.com</a></p>
                        </div><!-- /.bottom-top-content -->
                     </div><!-- /.col-md-9 -->
                     <div class="col-md-3">
                        <div class="bottom-content-right">
                            <div class="social-profile">
                                <span class="social-profole-title">SUIVEZ-NOUS:</span>
    ...
    <script>
        jQuery(document).ready(function() {
           jQuery(".carrent-slider").revolution({
                sliderType: "standard",
